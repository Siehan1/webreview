...
<body>
    ...
    <div class="section">
        <div class="container">
            ...
            <h2>
                <span><i class="fa fa-calendar-check-o" aria-hidden="true"></i> &nbsp;<?= $data['Year']?></span> 
                <span><i class="fa fa-clock-o" aria-hidden="true"></i>  &nbsp;<?= $data['Runtime']?></span> 
                <span><i class="fa fa-folder" aria-hidden="true"></i>  &nbsp;<?= $data['Genre']?></span>
                <span><i class="fa fa-star" aria-hidden="true"></i>  &nbsp;<?= $data['imdbRating']?></span>
            </h2>
            
            <div class="card-description"><?= $data['Plot']?></div>
