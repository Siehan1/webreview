...
<body>
    ...
    <div class="section">
        <div class="container">
            ...
            }elseif(array_key_exists('romance', $_GET)){
                $data = bacaFilmRomance();
                echo"<div class='section-header'>
                romance Movie
                </div>";
            }elseif(array_key_exists('comedy', $_GET)){
                $data = bacaFilmKomedi();
                echo"<div class='section-header'>
                comedy Movie
                </div>";
            }elseif(array_key_exists('drama', $_GET)){
                $data = bacaFilmDrama();
                echo"<div class='section-header'>
                drama Movie
                </div>";
            }elseif(array_key_exists('horror', $_GET)){
                $data = bacaFilmHorror();
                echo"<div class='section-header'>
                horror Movie
                </div>";
            ...
            <div class='row'>
             ...
             foreach ($data as $film) {
                ...
                <!-- MOVIE ITEM -->";
                echo"<a href='review.php?judul=$judul' class='movie-item'>
